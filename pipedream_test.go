...
func TestMain(m *testing.M) {
	var err error
	tmpDir, err = os.MkdirTemp(os.TempDir(), "nexusstream")
	if err != nil {
		panic(err)
	}
	defer func() {
...
func TestExport(t *testing.T) {
	testname := "$NEXUSSTREAM_EXPORTS file holds the correct data"
	t.Run(testname, func(t *testing.T) {
		value := "value"
		key := "key"
		Export(key, value)
...
func TestSteps(t *testing.T) {
	testname := "Steps holds the value of $NEXUSSTREAM_STEPS"
	t.Run(testname, func(t *testing.T) {
